    ...
    <div className="min-h-screen bg-gray-100">
      <div className="p-8">
        ...
        <div className="flex justify-between items-start mb-8">
          <div>
            <h1 className="text-2xl font-semibold text-black mb-2">Master Unit</h1>
        ...
        <div className="bg-white rounded-lg shadow-sm overflow-hidden border border-gray-200">
          ...
          <div className="border-b border-gray-300">
            <div className="grid grid-cols-12 gap-4 px-6 py-4 bg-gray-200">
              ...
              <div className="col-span-3 text-sm font-semibold text-black">Nama Unit</div>
              <div className="col-span-3 text-sm font-semibold text-black">Nama PIC</div>
              <div className="col-span-4 text-sm font-semibold text-black">Institute ID</div>
          ...
          <div>
            {filteredUnits.slice(0, 9).map((unit, index) => (
              <div key={unit.id} className="grid grid-cols-12 gap-4 px-6 py-4 border-b border-gray-200 last:border-b-0 hover:bg-gray-50">
          ...
          <div className="border-t border-gray-300 px-6 py-4 bg-gray-200">
            <div className="flex items-center justify-between">
              <div className="text-sm text-black">
                Showing <span className="font-semibold">{Math.min(filteredUnits.length, 9)}</span> of <span className="font-semibold">{filteredUnits.length}</span> results found
              </div>
